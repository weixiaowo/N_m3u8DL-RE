...
internal static class StaticText
{
    public static readonly Dictionary<string, TextContainer> LANG_DIC = new()
    {
        ...
        (
            zhCN: "指定HLS加密方式 (AES_128|AES_128_ECB|CENC|CHACHA20|BBTS|COPYRIGHTDRM|NONE|SAMPLE_AES|SAMPLE_AES_CTR|UNKNOWN)",
            zhTW: "指定HLS加密方式 (AES_128|AES_128_ECB|CENC|CHACHA20|BBTS|COPYRIGHTDRM|NONE|SAMPLE_AES|SAMPLE_AES_CTR|UNKNOWN)",
            enUS: "Set HLS encryption method (AES_128|AES_128_ECB|CENC|CHACHA20|BBTS|COPYRIGHTDRM|NONE|SAMPLE_AES|SAMPLE_AES_CTR|UNKNOWN)"
        ),
